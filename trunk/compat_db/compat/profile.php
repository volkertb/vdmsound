...
<?php
  ...
  echo('<tr><td align="right" width="50%">User:</td><td align="left" width="50%">' . $userinfo['name'] . '</td></tr>');
...
<?php
  ...
  echo('<form method="post" action="' . $SCRIPT_NAME . '"><table border="0" cellspacing="2" cellpadding="3" width="100%">');
  echo('<tr><td align="right" width="50%">' . HtmlHighlightError('Old password:', $error == E_AUTH_NO_SUCH_USER_PWD) . '</td><td align="left" width="50%"><input type="password" size="12" name="oldpwd" value="" maxlength="16"></td></tr>');
  echo('<tr><td align="right">' . HtmlHighlightError('New password:', $error == E_AUTH_INVALID_PASSWORD) . '</td><td align="left"><input type="password" size="12" name="newpwd1" value="" maxlength="16"></td></tr>');
  echo('<tr><td align="right">' . HtmlHighlightError('Confirm new password:', $error == E_AUTH_PASSWORD_MISMATCH) . '</td><td align="left"><input type="password" size="12" name="newpwd2" value="" maxlength="16"></td></tr>');
